...
public interface IDLListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link IDLParser#booleanliteral}.
	 * @param ctx the parse tree
	 */
	void enterBooleanliteral(IDLParser.BooleanliteralContext ctx);
	/**
	 * Exit a parse tree produced by {@link IDLParser#booleanliteral}.
	 * @param ctx the parse tree
	 */
	void exitBooleanliteral(IDLParser.BooleanliteralContext ctx);
}